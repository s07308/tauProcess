...
Under sufficient follow-up $\hat{\tau}_a(t)$ can be treated as $\hat{\tau}_a$ if we let 
$t = X_{(n_0)} \wedge X_{(n_1)}$. The p-value with respect to the null $H_0: \tau_a = 0$ may be calculated by the following steps:
